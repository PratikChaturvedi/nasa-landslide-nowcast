...
$.getJSON("global_landslide_nowcast_3hr.20200712.233000.geojson", function (data) {
 geoJsonLayer = L.geoJson(data, {
    style: style
      }).addTo(map);
controlLayers.addOverlay(geoJsonLayer, 'Landslide Nowcast 0500 hrs IST 13th July 2020');
