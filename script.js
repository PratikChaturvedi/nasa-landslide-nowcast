...
$.getJSON("global_landslide_nowcast_3h_20200710-1700-ist.geojson", function (data) {
 geoJsonLayer = L.geoJson(data, {
    style: style
      }).addTo(map);
controlLayers.addOverlay(geoJsonLayer, 'Landslide Nowcast 1700 hrs IST 10th July 2020');
