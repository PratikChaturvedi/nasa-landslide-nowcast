...
$.getJSON("global_landslide_nowcast_3h_20200712-0500-ist.geojson", function (data) {
 geoJsonLayer = L.geoJson(data, {
    style: style
      }).addTo(map);
controlLayers.addOverlay(geoJsonLayer, 'Landslide Nowcast 0500 hrs IST 12th July 2020');
